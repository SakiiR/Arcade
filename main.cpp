...
// Last update Thu Mar 31 17:05:59 2016 Barthelemy Gouby
//
...
int			main(int argc, char **argv)
{
  ...
  arcade.getLoader().loadInitialGameLibrary("games/lib_arcade_pacman.so");
  arcade.getLoader().loadInitialGraphicLibrary(argv[1]);
